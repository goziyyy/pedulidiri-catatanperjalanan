    ...
    <div class="p-4 max-w-sm">
        <div class="flex rounded-lg h-full dark:bg-gray-800 bg-gray-800 p-8 flex-col">
            <div class="flex items-center mb-3">
                ...
                <h2 class="text-white dark:text-white text-lg font-medium">Perhatikan Suhu Tubuh Anda!</h2>
            </div>
            <div class="flex flex-col justify-between flex-grow">
                <p class="leading-relaxed text-base text-white dark:text-gray-300">
                    Selalu rutin untuk menjaga kesehatan, dengan cara mengikuti pola hidup yang sehat dan tidak berharap pada dia yang tidak pasti. Semua orang perlu memperhatikan kesehatannya dengan baik, dimulai dari hal kecil yaitu perhatikanlah suhu tubuh anda. segera kontrol ke dokter jika ada gejala tertentu.
                </p>
    ...
    <div class="p-4 max-w-xl"> <!-- Mengubah max-w-lg menjadi max-w-xl -->
      <div class="shadow p-6 rounded-lg bg-white">
        <div class="md:flex md:justify-between md:items-center">
          <div>
            <h2 class="text-xl text-gray-800 font-bold leading-tight">Catatan Perjalanan.</h2>
            <p class="mb-2 text-gray-600 text-sm">Grafik Pencatatan Perjalanan  Bulanan</p>
          </div>

          <!-- Legends -->
          <div class="mb-12">
            <div class="flex items-center">
              <div class="w-2 h-2 bg-blue-600 mr-10 rounded-full"></div>
            </div>
          </div>
        </div>
...
<div class="p-4 max-w-sm">
        <div class="flex rounded-lg h-full dark:bg-gray-800 bg-gray-800 p-8 flex-col">
            <div class="flex items-center mb-3">
                ...
                <h2 class="text-white dark:text-white text-lg font-medium">Tinggalkan Jejak Perjalanan</h2>
            </div>
            <div class="flex flex-col justify-between flex-grow">
                <p class="leading-relaxed text-base text-white dark:text-gray-300">
                    Buat catatan pada menu Tambah Catatan, masukkan data sesuai dengan format yang telah diberikan. Rekam Jejak Perjalananmu secara digital, lihat history perjalanan anda pada View Catatan. 
                </p>
                <a href="#" class="mt-3 text-white dark:text-white hover:text-blue-600 inline-flex items-center">Learn More
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
